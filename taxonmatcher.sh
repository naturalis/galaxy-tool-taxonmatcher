...
if [ $3 == "gbif" ]
then
    python3 $SCRIPTDIR"/taxonmatcherV2_multicore_gbif.py" -i $1 -r $3 -t $2 -o $outlocation"/taxonmatched.txt" -g /home/galaxy/Tools/galaxy-tool-taxonmatcher/gbif_taxonmatcher
fi
